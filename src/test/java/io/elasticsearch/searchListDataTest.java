 ...
 * 描述:**
 * 
 * @author yanpenglei*@create 2017-11-23 20:33
 **/
...
public class searchListDataTest {
	 ...
	 * @return
	 */
	public String searchListData(String index, String type, long startTime, long endTime, Integer size, String matchStr)
			throws ParseException {

		StringBuffer stringBuffer = new StringBuffer();

		List<Map<String, Object>> tmpMap1 = ElasticsearchUtils.searchListData(index, type, startTime, endTime, size,
				null, null, false, null, matchStr);
		...
		for (String requestId : requestIdList) {
			...
			List<Map<String, Object>> tmpMap3 = ElasticsearchUtils.searchListData(assignservice_index,
					assignservice_type, startTime, endTime, size, null, null, false, null, assignservice_matchStr);
